...
create_pblock SLR2
add_cells_to_pblock [get_pblocks SLR2] [get_cells -quiet [list inst_wrapper/inst_kernel/msu/redun_wrapper]]
resize_pblock [get_pblocks SLR2] -add {CLOCKREGION_X0Y10:CLOCKREGION_X5Y14}

set_false_path -from [get_clocks inst_wrapper/inst_kernel/msu/redun_wrapper/inst/inst/clk_in1] -to [get_cells {inst_wrapper/inst_kernel/msu/redun_wrapper/locked_int[0]}]